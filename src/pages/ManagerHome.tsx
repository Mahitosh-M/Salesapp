...
export default function ManagerHome() {
 ...
 {edit !== undefined && <RecordEditor kind="tasks" record={edit || undefined} preset={edit ? {} : {assignedStaffId:""}} onClose={()=>setEdit(undefined)} onSaved={tasks.reload}/>}
 </main>;
}
